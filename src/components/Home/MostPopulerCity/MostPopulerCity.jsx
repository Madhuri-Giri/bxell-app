        ...
        <div className="container">
          <div className="row">
            <div className="col-12 homeMostPopularcitySecHED">
              ...
              <p>
                Discover the best things to do, restaurants, shopping, hotels,
                cafes, and places around the world by categories.
              </p>
            </div>
            {/* Card Columns */}
          ...
          <div className="exploreMoreListingBtnDiv">
            <NavLink to="explore-listings" className="exploreMoreListingBtn">
